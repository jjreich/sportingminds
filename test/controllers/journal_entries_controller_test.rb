...
class JournalEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal_entry" do
    assert_difference('JournalEntry.count') do
      post journal_entries_url, params: { journal_entry: { dateTimeOfTraining: @journal_entry.dateTimeOfTraining, duration: @journal_entry.duration, motivationLevel: @journal_entry.motivationLevel, organizedPractice: @journal_entry.organizedPractice, performanceLevel: @journal_entry.performanceLevel, sport: @journal_entry.sport, trainingAccomplished: @journal_entry.trainingAccomplished } }
    end
  ...
  test "should update journal_entry" do
    patch journal_entry_url(@journal_entry), params: { journal_entry: { dateTimeOfTraining: @journal_entry.dateTimeOfTraining, duration: @journal_entry.duration, motivationLevel: @journal_entry.motivationLevel, organizedPractice: @journal_entry.organizedPractice, performanceLevel: @journal_entry.performanceLevel, sport: @journal_entry.sport, trainingAccomplished: @journal_entry.trainingAccomplished } }
